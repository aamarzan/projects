...
# Manual nudges for SITE NAME placement relative to the number-circle center.
# These help keep labels away from dense point clouds and the legend.
LABEL_OVERRIDE = {
    "CMCH":  (0.22,  0.03),
    "DMCH":  (-0.52, 0.16),
    "RMCH":  (0.26, -0.18),
...
# Absolute label placements for sites that still overlap after the usual logic.
# Coordinates are (Longitude, Latitude) in map CRS EPSG:4326.
SITE_TEXT_ABSOLUTE_OVERRIDE = {
    "CMCH":  (92.34, 22.53),
    "SOMCH": (91.52, 24.98),
}

# Optional manual division label positions if a datasource lacks clean centroids
DIVISION_TEXT_OVERRIDE = {
    "Rangpur":    (89.35, 25.68),
    "Rajshahi":   (89.00, 24.56),
