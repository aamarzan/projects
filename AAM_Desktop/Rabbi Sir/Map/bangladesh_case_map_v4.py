...
def main():
    ...
    if args.show_division_names or True:
        name_col = None
        for cand in ["NAME_1", "name", "NAME", "Division", "division", "ADM1_EN", "ADM1_NAME", "ShapeName"]:
        ...
        if name_col is not None:
            for _, rr in adm1.iterrows():
                ...
                ax.text(pt.x, pt.y, str(rr[name_col]).strip(),
    ...
    for _, r in hos.iterrows():
        ...
        ax.text(lx, ly, site, fontsize=SITE_LABEL_SIZE, fontweight="bold", color=SITE_LABEL_COLOR,
