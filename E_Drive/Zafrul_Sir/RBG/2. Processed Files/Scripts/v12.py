...
# -*- coding: utf-8 -*-
r"""
V12 submission-master publication figure generator for the 874-driver accident-history manuscript.
...
Default output:
    E:\Zafrul_Sir\RBG\Update\Figures\v12_submission_master

Recommended local final run:
    python E:\Zafrul_Sir\RBG\Update\Scripts\Accident_Figure_v12_Submission_Master.py --version v12_submission_master --dpi 600 --bootstrap 100 --strict-vector
...
DEFAULT_VERSION = "v12_submission_master"
...
def write_final_submission_readiness(paths: RunPaths, records: list[dict[str, str]]) -> Path:
    ...
    lines.append("- The v12 package is the recommended programmatic figure set for manuscript-draft integration.")
...
def write_qc_report(paths: RunPaths, df: pd.DataFrame, sheets: dict[str,pd.DataFrame], qc:list, metrics:dict[str,float], validation_metrics:dict[str,float], dpi:int, manifest_path:Path, contact_sheet:Path, inventory_path:Path, checklist_path:Path) -> Path:
    ...
    lines=[]; lines.append("# v12 submission-master figure QC report\n")
