...
def qa_images(png):
    ...
    # Draw quality-control boundary boxes.
...
def main():
    ...
    create_zip(deliver)
    print(f'Generated {len(deliver)} output files: {ZIP}')
