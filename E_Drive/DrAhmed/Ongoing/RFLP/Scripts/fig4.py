...
Input source:
  - finalized assay definition table
"""
...
def main():
    ...
    ap.add_argument("--outdir", default=str(FINAL_FIG_DIR / "Fig_4"))
    ...
    fig.text(0.02, 0.02,
            "Computed solely from the finalized assay definition table (expected fragment sizes). "
