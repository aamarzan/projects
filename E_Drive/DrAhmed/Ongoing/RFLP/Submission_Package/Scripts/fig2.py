...
if __name__ == "__main__":
    ...
    p.add_argument("--panel_csv", default=str(SCRIPT_DIR / "panel_loci.csv"),
                   help="CSV for loci (or use defaults if missing)")
    p.add_argument("--out", default=str(FINAL_FIG_DIR / "Fig_2"))
    args = p.parse_args()
