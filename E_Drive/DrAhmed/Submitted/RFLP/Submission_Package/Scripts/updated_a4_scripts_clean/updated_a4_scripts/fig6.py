...
Input source: finalized assay definition table (expected fragment sizes). No invented results.
"""
...
DEFAULT_GEL3 = PROJECT_ROOT / "PDF_extract" / "Thesis Figures" / "f97.png"
...
def main():
    ...
    ap.add_argument("--assay_csv", default=str(DEFAULT_ASSAY_CSV))
    ap.add_argument("--outdir", default=str(FINAL_FIG_DIR / "Fig_6"))
    ...
    fig.text(
        0.02, 0.02,
        "All panels computed from the finalized assay definition table (expected fragment sizes). "
        "Risk uses minimum band spacing and smallest fragment; gel percent and ladder step are study electrophoresis inputs.",
